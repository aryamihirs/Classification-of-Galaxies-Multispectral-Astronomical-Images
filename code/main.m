...
MaskedIm_s1 = segment(str_s1,im_s1);
MaskedIm_s2 = segment(str_s2,im_s2);
MaskedIm_e1 = segment(str_e1,im_e1);
MaskedIm_e2 = segment(str_e2,im_e2);

classifier(MaskedIm_s1);
classifier(MaskedIm_s2);
classifier(MaskedIm_e1);
classifier(MaskedIm_e2);